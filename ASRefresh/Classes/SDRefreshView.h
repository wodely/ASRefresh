...
// 进入即将刷新状态没有更多数据了
#define SDRefreshViewNoMoreDataStateText @"没有更多数据啦 ╮(╯_╰)╭ ..."
...
//刷新后关掉动画，避免与collectionview动画冲突
@property (nonatomic, assign) BOOL noAnimateAfterRefresh;
